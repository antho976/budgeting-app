...
export default function Icon({ name, className = 'w-5 h-5' }) {
  const icons = {
    home: (
      <path strokeLinecap="round" strokeLinejoin="round" d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10" />
    ),
    list: (
    ...
    pencil: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232 18.768 8.768M4 20h3.75L17.81 9.94a2.652 2.652 0 0 0-3.75-3.75L4 16.25V20z" />
    ),
    chevronLeft: (
